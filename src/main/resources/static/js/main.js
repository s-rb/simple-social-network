      ...
      if (this.id) {
        messageApi.update({id: this.id}, message).then(result =>
            result.json().then(data => {
              ...
              // splice - замена элемента с индексом по индексу на др элемент
...
// При нажатии кнопки edit (input) срабатывает метод edit, в котором вызываем полученный снаружи метод editMethod и в
// него кладем текущий message
